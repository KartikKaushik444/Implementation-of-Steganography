...
public class LSB_decode {
	...
	static final String DECODEDMESSAGEFILE = "C:\\Users\\500068287\\Downloads\\Project Ideas\\message_dec.txt";
...
for(int i=0;i<len*8;i=i+8){
   ...
   out.write(msg);
   out.close();
   System.out.println("Hided message :  "+msg);
}
